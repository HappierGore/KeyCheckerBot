...
client.registerProgress = new Map();
client.registerMode = new Map();

client.comandos = new Discord.Collection();
//Controlador de comandos
for (const file of readdirSync(__dirname + '/comandos/')) {
...
for (const file of readdirSync(__dirname + '/eventos/')) {
    ...
    if (file.endsWith('.js')) {
        ...
        let fileContents = require(`${__dirname}/eventos/${file}`);
        ...
        delete require.cache[require.resolve(`${__dirname}/eventos/${file}`)];
    }
}
//Propiedad login
client
